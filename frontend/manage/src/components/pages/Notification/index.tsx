...
const Notification = () => {
  const { data: alarmContents, setHasNewAlarmOnRealTime, isFetched: isFetchedGetAlarmContents } = useGetAlarmContents();
  ...
  return (
    <ScreenContainer>
      <Container>
        <Title>알림</Title>
        <AlarmContainer>
          {isFetchedGetAlarmContents && <AlarmContent alarmContents={alarmContents || []} />}
        </AlarmContainer>
      </Container>
    </ScreenContainer>
  );
