...
==== (실패) 소셜 로그인 유저 대댓글 작성 실패 (대댓글에 대댓글을 다는경우)
==== Response
...
include::{snippets}/api/v1/comments/{id}/sub-comments/paging-success/http-request.adoc[]
include::{snippets}/api/v1/comments/{id}/sub-comments/paging-success/request-parameters.adoc[]

==== Response

include::{snippets}/api/v1/comments/{id}/sub-comments/paging-success/http-response.adoc[]
include::{snippets}/api/v1/comments/{id}/sub-comments/paging-success/response-fields.adoc[]
