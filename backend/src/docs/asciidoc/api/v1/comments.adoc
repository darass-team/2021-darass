...
include::{snippets}/api/v1/projects/comments/paging/get/success/http-request.adoc[]
include::{snippets}/api/v1/projects/comments/paging/get/success/request-parameters.adoc[]

==== Response

include::{snippets}/api/v1/projects/comments/paging/get/success/http-response.adoc[]
include::{snippets}/api/v1/projects/comments/paging/get/success/response-fields.adoc[]
