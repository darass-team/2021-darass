...
=== 특정 프로젝트에 해당하는 전체 댓글 개수 조회 (GET /api/v1/projects/comments/count)

==== Request

include::{snippets}/api/v1/projects/comments/count/get/success/http-request.adoc[]
include::{snippets}/api/v1/projects/comments/count/get/success/request-parameters.adoc[]

==== Response

include::{snippets}/api/v1/projects/comments/count/get/success/http-response.adoc[]
include::{snippets}/api/v1/projects/comments/count/get/success/response-fields.adoc[]
