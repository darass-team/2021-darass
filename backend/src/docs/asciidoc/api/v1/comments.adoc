...
=== 대댓글 조회 (GET /api/v1/comments/{id}/sub-comments

==== (성공) 대댓글 조회

==== Request

include::{snippets}/api/v1/comments/paging/get/sub-comments/success/http-request.adoc[]
include::{snippets}/api/v1/comments/paging/get/sub-comments/success/request-parameters.adoc[]

==== Response
include::{snippets}/api/v1/comments/paging/get/sub-comments/success/http-response.adoc[]
include::{snippets}/api/v1/comments/paging/get/sub-comments/success/response-fields.adoc[]

==== (실패) 부모 대댓글이 유효하지 않은 경우 대댓글 조회

==== Response
include::{snippets}/api/v1/comments/paging/get/sub-comments/fail/http-response.adoc[]
include::{snippets}/api/v1/comments/paging/get/sub-comments/fail/response-fields.adoc[]
