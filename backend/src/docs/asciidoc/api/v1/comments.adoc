...
==== URL에 해당하는 전체 댓글 과거순으로 조회 (sortOption: oldest)
...
==== URL에 해당하는 전체 댓글 과거순으로 조회 (sortOption: null)

==== Request

include::{snippets}/api/v1/comments/get/oldest-none-sortOption/success/http-request.adoc[]
include::{snippets}/api/v1/comments/get/oldest-none-sortOption/success/request-parameters.adoc[]

==== Response

include::{snippets}/api/v1/comments/get/oldest-none-sortOption/success/http-response.adoc[]
include::{snippets}/api/v1/comments/get/oldest-none-sortOption/success/response-fields.adoc[]

==== URL에 해당하는 전체 댓글 과거순으로 조회 (sortOption: 임의의 값)

==== Request

include::{snippets}/api/v1/comments/get/oldest-random-sortOption/success/http-request.adoc[]
include::{snippets}/api/v1/comments/get/oldest-random-sortOption/success/request-parameters.adoc[]

==== Response

include::{snippets}/api/v1/comments/get/oldest-random-sortOption/success/http-response.adoc[]
include::{snippets}/api/v1/comments/get/oldest-random-sortOption/success/response-fields.adoc[]
...
==== 특정 프로젝트에 해당하는 댓글 과거순으로 조회 (sortOption: null)

==== Request

include::{snippets}/api/v1/projects/comments/paging/get/oldest-none-sortOption/success/http-request.adoc[]
include::{snippets}/api/v1/projects/comments/paging/get/oldest-none-sortOption/success/request-parameters.adoc[]

==== Response

include::{snippets}/api/v1/projects/comments/paging/get/oldest-none-sortOption/success/http-response.adoc[]
include::{snippets}/api/v1/projects/comments/paging/get/oldest-none-sortOption/success/response-fields.adoc[]

==== 특정 프로젝트에 해당하는 댓글 과거순으로 조회 (sortOption: 임의의 값)

==== Request

include::{snippets}/api/v1/projects/comments/paging/get/oldest-random-sortOption/success/http-request.adoc[]
include::{snippets}/api/v1/projects/comments/paging/get/oldest-random-sortOption/success/request-parameters.adoc[]

==== Response

include::{snippets}/api/v1/projects/comments/paging/get/oldest-random-sortOption/success/http-response.adoc[]
include::{snippets}/api/v1/projects/comments/paging/get/oldest-random-sortOption/success/response-fields.adoc[]
